...
**修正：已經有人連著的時候，第二個連線會永遠卡在「等待對方同意」**
同一台 `aiterm-host` 同時只能有一個人操作鍵盤。以前第二個人連進來時，主機會把他放進「等待同意」，要等有人決定讓不讓他進來——但 `aiterm-host` 旁邊通常根本沒有人，所以他就一直卡在那個畫面。現在第二個人會直接以「唯讀」身分進來，看得到畫面但不能打字；等第一個人離開後，下次重新連線就能取得操作權。

**搭配桌面版 AITerm v1.26.0 一起更新**
如果你遇到的是「只有第一次連得上，之後每次都卡在 4 位數畫面」，那是桌面版關掉分頁時沒有真的斷線造成的，要把桌面版更新到 v1.26.0 才會好；這一版的 `aiterm-host` 只處理真的有兩個人同時連線的情況。
