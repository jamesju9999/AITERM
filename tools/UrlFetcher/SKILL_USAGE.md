# WebFetcher Skill 使用說明書

## 簡介

`WebFetcher` 是一個 C# .NET 命令行工具，提供給 AI（Claude）透過 Skill 調用，用於抓取網頁內容。此工具可以動態指定網址，獲取網頁內容，並提供給 AI 進行分析或處理。

## Skill 配置文件

### claude_skill_config.yaml
