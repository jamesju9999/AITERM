...
const zhTW = {
    ...
    board_transcript_raw_label: "執行記錄",
    board_transcript_maximize: "放到最大",
    board_transcript_restore: "還原大小",
    ...
    board_settings_max_concurrent_hint: "同一時間最多開幾個分頁執行工作。互動模式的工作不佔額度。",
    board_settings_claude_command_hint: "派工時用來啟動 Claude Code 的指令，通常是 claude。",
    board_settings_stuck_timeout: "疑似卡住判定時間（分鐘）",
    board_settings_stuck_timeout_hint: "非互動任務連續這麼久沒有任何終端機輸出，就會被標記失敗。Claude Code 自己派 subagent 在背景工作時常常會安靜好一陣子，不是真的卡住——調高這個數字可以避免誤判。",
    ...
    proj_remove_running_blocked: "這個專案還有工作在執行中，請先停止它們再移除專案。",
    proj_remove_failed: "無法移除專案：",
    report_err_no_cards: "這個專案還沒有任何工作項目，無法產生報告。",
    report_err_not_configured: "尚未設定 AI 供應商，請先到設定裡完成設定。",
    report_err_no_artifact: "AI 沒有產生報告文件。下面是它的原始回覆。",
    report_err_save_failed: "報告已產生，但存檔失敗：",
    report_model: "模型",
    report_new: "產生新報告",
    report_scope_title: "這次會包含",
    report_scope_total: "個工作項目",
    report_scope_pending: "個需要先整理對話記錄（會花比較久）",
    report_scope_cached: "全部都整理過了，這次會很快",
    report_scope_empty: "這個專案還沒有任何工作項目",
    report_col_planning: "規劃中",
    report_col_queued: "待執行",
    report_col_running: "執行中",
    report_col_done: "已完成",
    report_title: "工作報告",
    ...
    report_cancel: "取消",
    report_cancelling: "取消中，等目前這一項回來…",
    report_history: "歷史報告",
    report_history_empty: "還沒有產生過報告",
    board_action_archive: "封存",
    board_archive_column: "封存全部",
    board_archive_column_confirm: (n: number) => `確定要封存這 ${n} 張已完成的卡片嗎？資料會完整保留，之後可以從封存清單放回來。`,
    board_archive_column_empty: "「已完成」欄目前沒有卡片",
    board_archive_title: "封存的工作",
    board_search: "搜尋標題、內容或工作目錄",
    board_archive_open: "檢視封存",
    board_archive_empty: "還沒有封存任何工作",
    board_archive_no_match: "沒有符合的工作",
    board_archive_search: "搜尋標題、內容或工作目錄",
    board_archive_page: (cur: number, total: number) => `第 ${cur} / ${total} 頁`,
    board_archive_prev: "上一頁",
    board_archive_next: "下一頁",
    board_archive_restore: "放回看板",
    board_archive_count: (n: number) => `共 ${n} 張`,
    board_archived_at: "封存於",
    report_include_archived: "包含已封存的工作",
    board_save_needs_title: "還需要填標題",
    board_save_needs_dir: "還需要選工作目錄",
    board_refine: "✨ AI 潤飾",
    board_refine_busy: "潤飾中…",
    board_refine_undo: "↩ 還原",
    board_refine_hint: "把草擬的需求改寫成給 Claude Code 的任務指令",
    board_refine_err_empty: "AI 沒有回覆任何內容，請再試一次",
    report_history_delete: "刪除這份報告",
    report_history_delete_confirm: "確定要刪除這份報告嗎？檔案會從專案資料夾中移除，無法復原。",
    report_save_as: "另存為…",
    ...
    suggest_key: "灰字建議的接受鍵",
    suggest_key_desc: "輸入時，輸入框會用灰字顯示最近一筆符合開頭的歷史指令，按下這個鍵補上（不會自動送出）。",
    suggest_key_tab_label: "Tab",
    suggest_key_tab_desc: "按 Tab 補上建議；沒有建議時 Tab 維持原本行為。",
    suggest_key_right_label: "→（向右鍵）",
    suggest_key_right_desc: "游標在結尾時按 → 補上建議；否則 → 照常移動游標。",
    suggest_key_off_label: "關閉建議",
    suggest_key_off_desc: "不顯示灰字建議。",
    ...
    vcs_no_remote: "此本機 repo 沒有設定 GitHub remote（origin），無法使用團隊 PR 協作功能",
    ...
    empty_terminal_hint_start: "▶ 輸入指令開始執行",
    empty_terminal_hint_ai: "✨ 輸入 /ai 問 AI 問題",
    empty_terminal_hint_search: "🔍 Ctrl+F 搜尋指令歷史",
    empty_terminal_hint_bookmark: "⭐ 點選指令書籤快速重複執行",
    ...
    remote_terminal_ended_host_auth_failed: "主機金鑰不符，可能有人在中間攔截這條連線。",
    ...
    connect_key_label: "金鑰（選填）",
    connect_key_hint: "連 CLI host 用。留空則使用 6 位短碼。",
    connect_key_hint_edit: "留空則保留原本的金鑰。",
    connect_edit_title: "編輯「{name}」",
    connect_edit_save: "儲存變更",
    connect_edit_cancel: "取消編輯",
    connect_submit: "連線",
    connect_cancel: "取消",
    ...
    new_remote_terminal_desc: "連線到遠端電腦的終端機",
...
const enRaw = {
    ...
    task_bridge_direct: "No Claude Bridge (default)",
    ...
    board_mark_done_confirm: "Mark this task done? This ends tracking now — the tab stays reachable, but the board status becomes Done.",
    ...
    board_action_edit_label: "Change group",
    ...
    board_transcript_raw_label: "Execution record",
    board_transcript_maximize: "Maximize",
    board_transcript_restore: "Restore size",
    ...
    board_settings_max_concurrent_hint: "How many tabs may run work at once. Interactive tasks do not count against it.",
    board_settings_claude_command_hint: "The command used to launch Claude Code when dispatching. Usually claude.",
    board_settings_stuck_timeout: "Stuck-detection timeout (minutes)",
    board_settings_stuck_timeout_hint: "A non-interactive task with no terminal output for this long is marked failed. Claude Code often goes quiet for a while when it dispatches its own background subagents — that's not actually stuck. Raise this to avoid false failures.",
    ...
    proj_remove_running_blocked: "This project still has running tasks. Stop them before removing it.",
    proj_remove_failed: "Could not remove the project: ",
    report_err_no_cards: "This project has no tasks yet, so there is nothing to report on.",
    report_err_not_configured: "No AI provider is configured yet. Set one up in Settings first.",
    report_err_no_artifact: "The AI did not produce a report document. Its raw reply is below.",
    report_err_save_failed: "The report was generated but could not be saved: ",
    report_model: "Model",
    report_new: "New report",
    report_scope_title: "This report will cover",
    report_scope_total: "tasks",
    report_scope_pending: "need their transcript summarised first (this takes longer)",
    report_scope_cached: "All summaries are cached — this will be quick",
    report_scope_empty: "This project has no tasks yet",
    report_col_planning: "Planned",
    report_col_queued: "Queued",
    report_col_running: "Running",
    report_col_done: "Done",
    ...
    report_cancelling: "Cancelling — waiting for the current item to finish…",
    report_history: "Past reports",
    report_history_empty: "No reports yet",
    board_action_archive: "Archive",
    board_archive_column: "Archive all",
    board_archive_column_confirm: (n: number) => `Archive these ${n} finished cards? Everything is kept and can be restored from the archive.`,
    board_archive_column_empty: "The Done column is empty",
    board_archive_title: "Archived work",
    board_search: "Search title, body or folder",
    board_archive_open: "Archive",
    board_archive_empty: "Nothing archived yet",
    board_archive_no_match: "No matching work",
    board_archive_search: "Search title, body or folder",
    board_archive_page: (cur: number, total: number) => `Page ${cur} of ${total}`,
    board_archive_prev: "Previous",
    board_archive_next: "Next",
    board_archive_restore: "Restore",
    board_archive_count: (n: number) => `${n} cards`,
    board_archived_at: "Archived",
    report_include_archived: "Include archived work",
    board_save_needs_title: "Needs a title",
    board_save_needs_dir: "Needs a working folder",
    board_refine: "✨ Refine with AI",
    board_refine_busy: "Refining…",
    board_refine_undo: "↩ Undo",
    board_refine_hint: "Rewrite your draft into a task brief for Claude Code",
    board_refine_err_empty: "The AI returned nothing — try again",
    report_history_delete: "Delete this report",
    report_history_delete_confirm: "Delete this report? The file is removed from the project folder and cannot be recovered.",
    ...
    suggest_key: "Accept-suggestion key",
    suggest_key_desc: "While you type, the input shows the most recent matching history command in grey; press this key to accept it (it is not submitted automatically).",
    suggest_key_tab_label: "Tab",
    suggest_key_tab_desc: "Press Tab to accept; when there is no suggestion Tab behaves as usual.",
    suggest_key_right_label: "→ (Right arrow)",
    suggest_key_right_desc: "Press → with the caret at the end to accept; otherwise → moves the caret as usual.",
    suggest_key_off_label: "Off",
    suggest_key_off_desc: "Do not show inline suggestions.",
    ...
    vcs_no_remote: "This local repo has no GitHub remote (origin) configured — team PR features aren't available.",
    ...
    empty_terminal_hint_start: "▶ Type a command to run it",
    empty_terminal_hint_ai: "✨ Type /ai to ask AI a question",
    empty_terminal_hint_search: "🔍 Ctrl+F to search command history",
    empty_terminal_hint_bookmark: "⭐ Click a command bookmark to rerun it",
    ...
    remote_terminal_ended_host_auth_failed: "The host's key does not match. Someone may be intercepting this connection.",
    ...
    // Connect dialog
    connect_title: "Connect to a remote computer",
    ...
    connect_manual_placeholder: "192.168.1.33:47823",
    connect_key_label: "Key (optional)",
    connect_key_hint: "For CLI hosts. Leave blank to use a 6-digit code.",
    connect_key_hint_edit: "Leave blank to keep the saved key.",
    connect_edit_title: "Edit \"{name}\"",
    connect_edit_save: "Save changes",
    connect_edit_cancel: "Cancel editing",
    ...
    new_remote_terminal_desc: "Connect to a remote computer's terminal",
