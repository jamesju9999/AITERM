...
// 2. Robot / AI Providers Icon
export function RobotIcon({ size = 16, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
// 4. VCS / Branching Connections Icon
...
export function PaintbrushIcon({ size = 16, ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 22C17.5228 22 22 17.5228 22 12C22 11.5 21.5 11 21 11H13V3C13 2.5 12.5 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" />
...
// 11. VCS / Leaf Icon
export function LeafIcon({ size = 16, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
// 15. Collapse Sidebar Arrow Left Icon
...
// 17. Sidebar Close / Collapse Icon
export function PanelLeftCloseIcon({ size = 16, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
// 18. Sidebar Open / Expand Icon
export function PanelLeftOpenIcon({ size = 16, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
// 31. Maximize / Minimize（AI 面板放大縮小）
...
// 33. History / Undo Clock Icon（首頁「接續上次的工作」）
...
// 35. Chart / Bar Chart Icon（首頁「今日 AI 用量」）
...
// 36. Download Icon（Artifact 面板：把 HTML 文件存成檔案）
...
// 37b. Clipboard List Icon（側邊欄「工作看板」按鈕）
